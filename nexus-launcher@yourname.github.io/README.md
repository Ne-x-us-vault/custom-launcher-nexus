...
To publish a release after committing your changes:
...
Create the GitHub Release from the `v1.0.0` tag and attach `custom-launcher@nexus.dev.zip` as the installable asset.
